...
#    model.add(Dense(1,activation='sigmoid'))
    ...
    x = Dense(50, name = model_sigloss.name+'_layer_1', activation='relu', regularization=keras.regularizers.l2(0.01))(model_sigloss.inputs)
    x = Dropout(0.2)(x)
    # x = Dense(25, name = model_sigloss.name+'_layer_2', activation='relu', regularization=keras.regularizers.l2(0.01))(x)
    # x = Dropout(0.2)(x)
    # x = Dense(25, name = model_sigloss.name+'_layer_3', activation='relu', regularization=keras.regularizers.l2(0.01))(x)
    # x = Dropout(0.2)(x)
    model_sigloss.outputs = Dense(1, name = model_sigloss.name+'_output',  activation='sigmoid', regularization=keras.regularizers.l2(0.01))(x)
