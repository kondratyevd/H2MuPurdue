...
#    model.add(Dense(1,activation='sigmoid'))
    ...
    x = Dense(50, name = model_sigloss_asimov.name+'_layer_1', activation='relu', kernel_regularizer=l2(0.0001))(model_sigloss_asimov.inputs)
    x = Dropout(0.2)(x)
    ...
    # x = Dropout(0.2)(x)
    model_sigloss_asimov.outputs = Dense(1, name = model_sigloss_asimov.name+'_output',  activation='sigmoid', kernel_regularizer=l2(0.0001))(x)
