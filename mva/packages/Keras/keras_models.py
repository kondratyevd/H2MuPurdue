...
#    model.add(Dense(1,activation='sigmoid'))
    ...
    x = Dense(50, name = model_sigloss.name+'_layer_1', activation='relu', kernel_regularizer=l2(0.0029))(model_sigloss.inputs)
    x = Dropout(0.2)(x)
    ...
    # x = Dropout(0.2)(x)
    model_sigloss.outputs = Dense(1, name = model_sigloss.name+'_output',  activation='sigmoid', kernel_regularizer=l2(0.0029))(x)
